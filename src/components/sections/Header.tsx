...
export function Header() {
  return <div className="border-b border-gray-800 pb-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
        ...
        <div className="btn-primary text-black px-3 py-1 rounded font-bold text-sm mt-2 md:mt-0">
      ...
      <div className="mt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
          <div className="flex items-center gap-2 text-gray-400">
            <MapPinIcon size={14} className="text-primary-color" />
            <span>Hyderabad, India</span>
          </div>
          <div className="flex items-center gap-2 text-gray-400">
            <AtSignIcon size={14} className="text-primary-color" />
            <span>hotmailsuraj@gmail.com</span>
          </div>
          <div className="flex items-center gap-2 text-gray-400">
            <PhoneIcon size={14} className="text-primary-color" />
            <span>+91 8766039312</span>
          </div>
          <div className="flex items-center gap-2 text-gray-400">
            <LinkedinIcon size={14} className="text-primary-color" />
            <span>linkedin.com/in/s0oraj</span>
          </div>
          <div className="flex items-center gap-2 text-gray-400">
            <GithubIcon size={14} className="text-primary-color" />
            <span>github.com/s0oraj</span>
          </div>
          <div className="flex items-center gap-2 text-gray-400">
            <svg className="w-3.5 h-3.5 text-primary-color" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="flex mt-4 space-x-2">
          <button className="flex items-center btn-primary hover:bg-[#4DA21D] text-black px-4 py-1 rounded-sm font-medium">
